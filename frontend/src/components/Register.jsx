            ...
            <div class="w-full lg:w-1/2 p-6 lg:p-12 bg-gray-400 dark:bg-gray-800">
                <div class="max-w-md mx-auto">
                    ...
                    <form class="space-y-4" onSubmit={ handleRegister }  >
                        ...
                        <div class="flex flex-col md:flex-row gap-4">
                            <button type="button" class="w-full md:w-1/2 flex items-center dark:text-white justify-center dark:bg-gray-600 gap-2 bg-gray-300 text-black rounded-lg p-3 dark:hover:bg-gray-900 hover:bg-white transition-colors">
                            ...
                            <button type="button" class="w-full md:w-1/2 flex items-center dark:bg-gray-600 dark:text-white justify-center gap-2 bg-gray-300 text-black rounded-lg p-3 dark:hover:bg-gray-900 hover:bg-white transition-colors">
                                <svg class="w-5 h-5" viewBox="0 0 24 24">
