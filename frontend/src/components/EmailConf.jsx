...
export default function  EmilConfirmation(){
    ...
    return(
        <div class="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8"> 
            ...
            <p
                class="mt-1 text-4xl font-extrabold text-black-900 dark:text-white-100 sm:text-5xl sm:tracking-tight lg:text-6xl">
                Your account is now
            ...
            <p class="max-w-3xl mt-5 mx-auto text-xl text-black-500 dark:text-white-300">Take the leap and unleash your
